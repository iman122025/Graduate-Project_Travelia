        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">احصائيات الموقع</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <div class="col-xl-4">
                        ...
                        <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5"> {{count($bookings)}}</div>
                                <!--end::Svg Icon-->
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5">عدد الحجوزات</div>
                                <div class="fw-bold text-white">عدد الحجوزات في المنصة</div>
                            </div>
                            <!--end::Body-->
                        </a>
                    ...
                    <div class="col-xl-4">
                        ...
                        <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5"> {{count($hotels)}}</div>
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5">عدد الفنادق</div>
                                <div class="fw-bold text-white">عدد الفنادق في المنصة</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-4">
                        ...
                        <a href="#" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5"> {{count($customers)}}</div>
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5"> عدد العملاء</div>
                                <div class="fw-bold text-white">عدد العملاء في المنصة</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
