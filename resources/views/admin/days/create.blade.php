        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">اضافة يوم</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">اضافة يوم</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-12 me-xl-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-12">
                                    ...
                                    <!--begin::Form-->
                                <form action="{{ route('admin.days.store') }}" method="POST" id="kt_invoice_form" enctype="multipart/form-data">
                                    <!--begin::Wrapper-->
                                    @csrf
                                    <!--end::Separator-->
                                    <!--begin::Wrapper-->
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" value="{{ old('title') }}" name="title" id="title" class="form-control form-control-solid" placeholder="مثال: جبال طرابزون" />
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">الموقع</label>
                                                    <input type="text" value="{{ old('location') }}" id="location" name="location" class="form-control form-control-solid" placeholder="مثال: شمال غرب البحر الأسود" />
                                                </div>
                                                <div class="mb-5">
                                                    <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">الأنشطة</label>
                                                    <textarea rows="7" id="activities" name="activities"  class="form-control form-control-solid" >{{ old('activities') }}</textarea>
                                                </div>
